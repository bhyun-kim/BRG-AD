...
class pscBeam_Dataset(TorchDataset):
    ...
    def __init__(self, root: str, normal_class: int = 0, known_outlier_class : int = 1, 
        ...
        train_set = pscBeam(root=self.root, train_type='train')
        train_set.load_data()   
        ...
        # Get test set 
        self.test_set = pscBeam(root=self.root, train_type='test')
...
class pscBeam: 
    ...
    def read_data(self, idx):
        ...
        data = np.stack((data_dict['ch_0'], data_dict['ch_1'], data_dict['ch_2'], data_dict['ch_3']))
