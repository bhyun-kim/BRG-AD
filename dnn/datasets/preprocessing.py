...
def create_semisupervised_setting(labels : np.array, normal_classes: tuple, outlier_classes: tuple, known_outlier_classes: tuple,
    ...
    logger.info("No. of known normal data {}:".format(n_normal))
    logger.info("No. of outlier data {}:".format(n_outlier))
    ...
    logger.info("No. of known normal data {}:".format(n_known_normal))
    logger.info("No. of unlabeled normal data {}:".format(n_unlabeled_normal))
    logger.info("No. of known outlier {}:".format(n_known_outlier))
    logger.info("No. of unlabeled outlier {}:".format(n_unlabeled_outlier))
